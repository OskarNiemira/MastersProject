...
if burst_indices_start.size > 0 and burst_indices_end.size > 0:
   # If multiple bursts are detected, you would iterate over them
   for start, end in zip(burst_indices_start, burst_indices_end):
       burst_data = data[start:end]
       # Now burst_data contains the burst range from start to end
       # The rest of your code to create a new FITS file goes here
